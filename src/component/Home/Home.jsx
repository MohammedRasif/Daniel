          ...
          <div className="w-full max-w-7xl mx-auto mb-6  my-10">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="mb-4 sm:mb-0 flex-1/2">
                <h3 className="text-[28px] font-semibold text-[#727692] mb-2 border-b border-gray-300 mr-10">
                  Contact Details
                </h3>
                <div className="space-y-2 flex gap-4 flex-col md:flex-row">
                  <div>
                    <div className="flex items-center">
                      ...
                      <span className="text-[17px] text-gray-600">0123456789</span>
                    </div>
                    <div className="flex items-center">
              ...
              <div className="flex-1">
                <h3 className="text-[28px] font-semibold text-[#727692] border-b border-gray-300 mb-2">
                  Time
                </h3>
